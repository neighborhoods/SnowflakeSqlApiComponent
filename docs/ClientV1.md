...
$container = (new TinyContainerBuilder())
    ...
    ->addSourcePath('vendor/neighborhoods/snowfalke-sql-api-component/fab/ClientV1')
    ->addSourcePath('vendor/neighborhoods/snowfalke-sql-api-component/src/ClientV1')
