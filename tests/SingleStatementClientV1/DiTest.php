...
namespace Neighborhoods\SnowflakeSqlApiComponent\Tests\SingleStatementClientV1;
...
class DiTest extends TestCase
{
    ...
    public function testDi(): void
    {
        ...
        $container = (new TinyContainerBuilder())
            ...
            ->addSourcePath('fab/SingleStatementClientV1')
            ->addSourcePath('src/SingleStatementClientV1')
            ...
            ->makeAllPublic()
            ->build();
        Assert::assertNotNull($container->get(SingleStatementClientV1\ClientInterface::class));
    }
}
